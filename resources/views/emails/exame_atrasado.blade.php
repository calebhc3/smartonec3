...
<body>
    <div class="container">
        <!-- Cabeçalho -->
        <div class="header">
            <img src="{{ asset('img/logo.png') }}" alt="Logo C3Saúde">
        ...
        <div class="content">
            ...
            <p>Seu exame está agendado para <strong>{{ $agendamento->data_exame->format('d/m/Y') }}</strong> às <strong>{{ $agendamento->horario_exame }}</strong>.</p>
